<?php
   ...
   if(isset($_POST['edit_basicinfo']))
  {
    
       $user->edit_basicinfo($_POST['uncode'],$_POST['fullname'],$_POST['status'],$_POST['visaNo'], $_POST['visaIssuer'],setDate($_POST['passportIssue']),setDate($_POST['visaExpiry']),
      ...
      $_POST['passportNumber'],setDate($_POST['idCardExpiryDate']),$_GET['id']);    
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <?php 
												// In the view
												$employee = $user->display_onebasicinfo($_GET['id']);
												
												foreach($employee as $row){ //for each object in the array		
		  ...
		  <form method="post">
                            <div class="row">
                              <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                ...
                                <input  value="<?php echo $row->Uncode;?>" type="text" class="form-control" placeholder="رقم الموظف" id="uncode" name="uncode"
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                  ...
                                  <input value="<?php echo $row->FullName;?>" type="text" class="form-control" placeholder="اسم الموظف الثلاثي" id="fullname" name="fullname"
                                   required>
                                  <br>
                              </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <select  class="form-control" name="status" required>
                                        <option value="1" <?php  echo ($row->MaritalStatus==1)?  'selected': '';?>>أعزب</option>
                                        <option value="2"  <?php echo ($row->MaritalStatus==2)? 'selected': '';?>>متزوج</option>
                                    </select>
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <select class="form-control" name="gender" required>
                                        <option value="male"<?php  echo ($row->Gender=='male')?  'selected': '';?>>ذكر</option>
                                        <option value="female"<?php  echo ($row->Gender=='female')?  'selected': '';?>>انثى</option>
                                    </select>
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <label for="job">المهنة</label>
                                    <input value="<?php echo $row->Profession;?>" type="text" class="form-control" placeholder="المهنة" id="profession" name="profession" required>
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <label for="">مكان الميلاد</label>
                                    <input value="<?php echo $row->Birthplace;?>" type="text" class="form-control" placeholder="مكان الميلاد" name="birthplace" required>
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <label for="birthDate">تاريخ الميلاد</label>
                                    <input value="<?php echo showDate($row->DateofBirth);?>" type="text" name="birthDate" id="birthDate" class="ddinput form-control" data-large-mode="true" id="birthDate" name="birthDate" required>
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <label for="visaNo">رقم التأشيرة</label>
                                    <input value="<?php echo $row->VisaNumber;?>" type="text" class="form-control" placeholder="رقم التأشيرة" id="visaNo" name="visaNo"
                                     pattern="[0-9]*"
                                     required
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <input value="<?php echo $row->VisaIssuer;?>" type="text" class="form-control" placeholder="جهة إصدار التأشيرة" id="visaIssuer" name="visaIssuer" required>
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <label for="">تاريخ إصدار التأشيرة</label>
                                    <input value="<?php echo $row->VisaIssuance;?>" type="text" name="visaIssuance" id="visaIssuance" class="ddinput form-control" data-large-mode="true" required>
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <label for="">تاريخ انتهاء التأشيرة</label>
                                    <input value="<?php echo showDate($row->VisaExpiry);?>" type="text" name="visaExpiry" id="visaExpiry" class="ddinput form-control" data-large-mode="true" required>
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <label for="PassportNo">رقم جواز السفر</label>
                                    <input value="<?php echo $row->PassportNumber;?>" type="text" id="passportNumber" name="passportNumber"class="form-control" placeholder="رقم جوزاز السفر (مثال : N 123456789)"
                                     pattern="N\s[0-9]{9}"
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <input value="<?php echo $row->PassportIssue;?>" type="text" name="passportIssue" id="passportIssue" class="ddinput form-control" data-large-mode="true" required>
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <label for="">تاريخ انتهاء الجواز</label>
                                    <input value="<?php echo $row->PassportExpiry;?>" type="text" name="passportExpiry" id="passportExpiry" class="ddinput form-control" data-large-mode="true" required>
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <label for="">تاريخ انتهاء كرت الهوية</label>
                                    <input value="<?php echo $row->VisaExpiry;?>" type="text" name="idCardExpiryDate" id="idCardExpiryDate" class="ddinput form-control" data-large-mode="true" required>
                                    <br>
                                </div>
                            </div>
                            <div class="margin-top-30 text-center">
                              <button id="edit_basicinfo" name="edit_basicinfo"  type="submit" class="btn btn-success update-pro">تعديل</button>
                            </div>
                        </form>
